...
* **Java Exercises:** Open the driver class containing the `main` method and click the clickable **Run** link appearing directly above line definition.
